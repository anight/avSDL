/* Borland BGI DEFAULT_FONT 8x8 bitmap, extracted from the original
 * executable (0x41-0x7A verified byte-identical against the linked CGA
 * BGI driver; 0x20-0x40 captured from the running program under DOSBox). */
#include "cga.h"

const unsigned char bgi_font8x8[256][8] = {
    ...
    {0x7c,0xc6,0xc6,0xc6,0xc6,0xc6,0x7c,0x00}, /* 0x30 '0' */
    ...
    {0x7c,0xc6,0xc6,0xc0,0xc0,0xc6,0x7c,0x00}, /* 0x43 'C' */
    ...
    {0x7c,0xc6,0xc6,0xc6,0xc6,0xc6,0x7c,0x06}, /* 0x51 'Q' */
    {0xfc,0xc6,0xc6,0xfc,0xc6,0xc6,0xc6,0x00}, /* 0x52 'R' */
    {0x78,0xcc,0x60,0x30,0x18,0xcc,0x78,0x00}, /* 0x53 'S' */
    ...
    {0xc3,0xc3,0x66,0x3c,0x18,0x18,0x18,0x00}, /* 0x59 'Y' */
    ...
    {0x00,0x38,0x6c,0xc6,0x00,0x00,0x00,0x00}, /* 0x5e '^' */
    {0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xff}, /* 0x5f '_' */
    {0x30,0x30,0x18,0x00,0x00,0x00,0x00,0x00}, /* 0x60 '`' */
    {0x00,0x00,0x7c,0x06,0x7e,0xc6,0x7e,0x00}, /* 0x61 'a' */
    {0xc0,0xc0,0xfc,0xc6,0xc6,0xe6,0xdc,0x00}, /* 0x62 'b' */
    {0x00,0x00,0x7c,0xc6,0xc0,0xc0,0x7e,0x00}, /* 0x63 'c' */
    {0x06,0x06,0x7e,0xc6,0xc6,0xce,0x76,0x00}, /* 0x64 'd' */
    {0x00,0x00,0x7c,0xc6,0xfe,0xc0,0x7e,0x00}, /* 0x65 'e' */
    {0x1e,0x30,0x7c,0x30,0x30,0x30,0x30,0x00}, /* 0x66 'f' */
    {0x00,0x00,0x7e,0xc6,0xce,0x76,0x06,0x7c}, /* 0x67 'g' */
    {0xc0,0xc0,0xfc,0xc6,0xc6,0xc6,0xc6,0x00}, /* 0x68 'h' */
    {0x18,0x00,0x38,0x18,0x18,0x18,0x3c,0x00}, /* 0x69 'i' */
    {0x18,0x00,0x38,0x18,0x18,0x18,0x18,0xf0}, /* 0x6a 'j' */
    ...
    {0x00,0x00,0xfc,0xc6,0xc6,0xe6,0xdc,0xc0}, /* 0x70 'p' */
    {0x00,0x00,0x7e,0xc6,0xc6,0xce,0x76,0x06}, /* 0x71 'q' */
    {0x00,0x00,0x6e,0x70,0x60,0x60,0x60,0x00}, /* 0x72 'r' */
    ...
    {0x00,0x00,0xc6,0xc6,0xce,0x76,0x06,0x7c}, /* 0x79 'y' */
    {0x00,0x00,0xfc,0x18,0x30,0x60,0xfc,0x00}, /* 0x7a 'z' */
